 ...
 * 字体不跟宿主默认栈：UI 文字走圆润人文栈（Aptos→Calibri→Corbel，中文落雅黑系），
 * 模型/来源标识与原始 JSON 走圆头等宽（Cascadia Mono→Consolas）。
 *
...
.tpq{display:inline-flex;align-items:center;gap:4px;position:relative;
 --tpq-font:"Aptos","Bierstadt","Calibri","Corbel","Segoe UI Variable Text",
  "PingFang SC","Microsoft YaHei UI","Microsoft YaHei",system-ui,sans-serif;
 --tpq-mono:"Cascadia Mono","Cascadia Code","SF Mono",Consolas,ui-monospace,SFMono-Regular,monospace;
