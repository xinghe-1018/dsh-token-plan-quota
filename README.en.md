...
node test/client.mjs                # 168 assertions, fake React/DOM/fetch
...
config table, 8 sources, 8 declared outbound hosts, 379/168 tests" - and checks them against the code and a real
