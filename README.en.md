...
node test/guards.mjs                # 94 assertions: behaviour matrices of the gates themselves
...
config table, 8 sources, 8 declared outbound hosts, 379/207 tests plus 94 guards assertions" - and checks them
