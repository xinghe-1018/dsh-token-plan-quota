 ...
 * 静默落 Aptos/Calibri/雅黑系统栈），模型/来源标识与 debug 骨架走 Geist Mono→Cascadia/Consolas。
 *
...
.tpq{display:inline-flex;align-items:center;gap:4px;position:relative;
 --tpq-font:"Geist Variable","Noto Sans SC Variable","Aptos","Bierstadt","Calibri","Corbel","Segoe UI Variable Text",
...
.tpq-big{font-size:15px;font-weight:600;font-variant-numeric:tabular-nums;
...
.tpq-updated{display:block;width:100%;margin-top:6px;padding:2px 0;border:none;background:transparent;
 font:inherit;font-size:11px;font-variant-numeric:tabular-nums;text-align:right;cursor:pointer;
