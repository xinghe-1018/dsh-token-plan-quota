...
node test/client.mjs                # 192 assertions, fake React/DOM/fetch
...
config table, 8 sources, 8 declared outbound hosts, 379/192 tests" - and checks them against the code and a real
